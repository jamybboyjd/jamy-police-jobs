Locales['en'] = {
  ...
  ['statetrooper_wear'] = 'statetrooper Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~statetrooper~s~',
  -- Vehicle interaction
  ...
  ['quantity'] = 'quantity',
  ['inventory'] = 'inventory',
  ['statetrooper_stock'] = 'statetrooper Stock',
  -- Misc
  ['remove_prop'] = 'press ~INPUT_CONTEXT~ to delete the object',
  ['map_blip'] = 'statetrooper Station',
  ['unrestrained_timer'] = 'you feel your handcuffs slowly losing grip and fading away.',
  -- Notifications
  ['alert_statetrooper'] = 'statetrooper alert',
  ['phone_statetrooper'] = 'statetrooper',
}
